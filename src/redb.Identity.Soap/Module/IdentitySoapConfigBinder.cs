...
/// <see cref="IdentitySoapTransportOptions"/> for the WS-Trust facade.
/// </summary>
/// <remarks>
/// Mirrors <c>redb.Identity.Http.Module.IdentityHttpConfigBinder</c> and its gRPC twin: Tsak hands the merged 5-layer
...
/// <c>context.json</c> carries every facade: <c>IdentityTransport:Http:*</c>, <c>IdentityTransport:Grpc:*</c> and
/// <c>IdentityTransport:Soap:*</c>.
/// </para>
/// </remarks>
internal static class IdentitySoapConfigBinder
{
    ...
    /// <summary>
    /// Builds <see cref="IdentitySoapTransportOptions"/> from the context's
    ...
    /// </summary>
    public static IdentitySoapTransportOptions Bind(IRouteContext context)
    {
        ArgumentNullException.ThrowIfNull(context);

        var options = new IdentitySoapTransportOptions();
    ...
    /// </summary>
    private static void BindSharedSection(IRouteContext context, IdentitySoapTransportOptions options)
    {
